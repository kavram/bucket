...
public class EmailUtils {
	...
	public void processPendingEmails() throws Exception{
	...
	private void sendAndUpdateStatus(IObject obj){
		try {
			...
			send(from, recip, subj, body, null);
			updateStatus(obj);
	...
	public void send(String from, String recipient, String subject, String message, String fromName) throws Exception	  {

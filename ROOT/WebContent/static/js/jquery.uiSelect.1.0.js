/*  uiSelect Plugin takes 3 parameters First Param (object) - for the left and top offsets - must be a numerical value
...
*
*   $('selector').uiSelect({leftOffset: -10, topOffset: 0},'uiList','uiInput');
*   */
        ...
        uiSelect: function(options,menuID,inputID) {
            ...
            return this.each(function() {
                ...
                .click(function(){
                    ...
                    $("#" + menuID).css( {
                        "left": (position.left + o.leftOffset) + "px",
                        "top": (position.top + uiHeight) + "px"
                    } );
                    $("#" + menuID).slideDown();
                    return false;
                })
